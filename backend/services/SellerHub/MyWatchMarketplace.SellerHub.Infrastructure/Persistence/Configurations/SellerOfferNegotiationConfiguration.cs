...
public class SellerOfferNegotiationConfiguration : IEntityTypeConfiguration<SellerOfferNegotiation>
{
    public void Configure(EntityTypeBuilder<SellerOfferNegotiation> builder)
    {
